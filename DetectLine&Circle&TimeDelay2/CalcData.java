...
public class CalcData {
	public static final double MAX_SLOPE_THRESHOLD = 0.05,MAX_RDIFFERENCE_THRESHOLD = 3,MAX_JITTER_THRESHOLD = 5;	//最大斜率差阈值,最大半径差像素阈值，最大抖动误差阈值
	...
	*/
	...
	public PointLoc calcRCenter(BufferedImage bi){			//计算圆心坐标
